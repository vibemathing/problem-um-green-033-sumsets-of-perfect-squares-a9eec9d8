...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-033-sumsets-of-perfect-squares-a9eec9d8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-033"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-033-sumsets-of-perfect-squares-a9eec9d8-v1",
      "problem_contract_sha256": "69890ff6e7d2b5f0b7e3854749e79d20ab3fb72ed01152124ace6fa175e9fcee",
      "problem_id": "problem:um-green-033-sumsets-of-perfect-squares-a9eec9d8",
      "route_id": "route:um-green-033-sumsets-of-perfect-squares-a9eec9d8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-033-sumsets-of-perfect-squares-a9eec9d8-source-fidelity-01",
      "graph_id": "graph:um-green-033-sumsets-of-perfect-squares-a9eec9d8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-033-sumsets-of-perfect-squares-a9eec9d8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-033-sumsets-of-perfect-squares-a9eec9d8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there an absolute constant $c > 0$ such that if $A \\subset \\mathbb{N}$ is a set of squares of size at least 2, then $|A + A| \\geq |A|^{1+c}$?"
          },
          "statement_sha256": "9043fcef2026de6b718083026c1f7050022053ed3e9b47ad42ae749e60aad166"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-033-sumsets-of-perfect-squares-a9eec9d8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-033-sumsets-of-perfect-squares-a9eec9d8-root",
      "route_id": "route:um-green-033-sumsets-of-perfect-squares-a9eec9d8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-033-b69bbc7b0b59",
        "url": "https://www.unsolvedmath.com/problems/GREEN-033"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
